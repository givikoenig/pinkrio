...
class UsersController extends AdminController
{
    ...
    public function __construct(RolesRepository $rol_rep, UsersRepository $us_rep) {
        ...
        $this->template = config('app.theme').'.admin.users';
    ...
    public function index()
    {
        ...
        $this->content = view(config('app.theme').'.admin.users_content')->with(['users'=>$users ])->render();
    ...
    public function create()
    {
        ...
        $this->content = view(config('app.theme').'.admin.users_create_content')->with('roles',$roles)->render();
    ...
    public function edit(User $user)
    {
       $this->title =  'Редактирование пользователя - '. $user->name;
        ...
        $this->content = view(config('app.theme').'.admin.users_create_content')->with(['roles'=>$roles,'user'=>$user])->render();
