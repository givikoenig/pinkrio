...
<div class="widget-first widget recent-posts">
	@if($articles)
	{{-- trans('ru.from_blog') --}}
		<h3>{{-- trans('ru.from_blog') --}}Recent Posts</h3>
		<div class="recent-post group">
	
		@foreach($articles as $article)
			<div class="hentry-post group">
				<div class="thumb-img"><img src="{{ asset(config('app.theme')) }}/images/articles/{{ $article->img->mini }}" alt="001" title="001" /></div>
				<div class="text">
...
<div class="widget-last widget text-image">
	...
	<div class="text-image" style="text-align:left"><img src="{{ asset(config('app.theme')) }}/images/callus.gif" alt="Customer support" /></div>
