				                ...
				                <div id="portfolio" class="portfolio-big-image">
				                	...
				                	<div class="hentry work group">
				                		<div class="work-thumbnail">
				                			<div class="nozoom">
				                				<img src="{{ asset(config('app.theme')) }}/images/projects/{{ $portfolio->img->max }}" alt="{{ $portfolio->title }}_img" title="{{ $portfolio->title }}" />							
				                				<div class="overlay">
				                					<a class="overlay_img" href="{{ asset(config('app.theme')) }}/images/projects/{{ $portfolio->img->path }}" rel="lightbox" title="{{ $portfolio->title }}"></a>
				                		...
				                		<div class="work-description">
				                			...
				                			<p>{!! str_limit($portfolio->text, 700) !!}</p>
				                			<div class="clear"></div>
