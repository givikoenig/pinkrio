				                    ...
				                    <div id="portfolio" class="portfolio-full-description">
				                        ...
				                        <div class="portfolios hentry work group">
				                            <div class="work-thumbnail">
				                                <a class="thumb"><img src="{{ asset(config('app.theme')) }}/images/projects/{{ $portfolio->img->max }}" alt="{{ $portfolio->title }}_img" title="{{ $portfolio->title }}" /></a>
				                            </div>
				                        ...
				                        <div class="portfolio-full-description-related-projects">
											...
											<div class="related_project">
				                                <a class="related_proj related_img" href="{{ route('portfolios.show',['alias'=>$portfolio->alias]) }}" title="{{ $portfolio->title }}"><img src="{{ asset(config('app.theme')) }}/images/projects/{{ $portfolio->img->mini }}" alt="{{ $portfolio->title }}_img" title="{{ $portfolio->title }}" /></a>
