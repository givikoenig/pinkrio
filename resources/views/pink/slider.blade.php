...
<div id="slider-cycle" class="slider cycle no-responsive slider_cycle group" style="height:485px;">
	<ul class="slider">
		...
		<li>
			<div class="slide-holder" style="background: url('{{ asset(config('app.theme')) }}/images/{{ $slider->img }}') no-repeat center center" style="height:483px;">
		...
		<div id="yit-widget-area" class="group">
			<div class="yit-widget-content inner group">
				<div class="widget-first yit-widget widget col1_4 one-fourth col widget-icon-text group">
					<img class="icon-img" src="{{config('app.theme')}}/images/icons/cloud.jpg" alt="" />		
					<h3><a class="text-color" href="#" title="">Great Design</a></h3>
					<p>A widgetized area: add shorcodes, text, icons and <a href="#"> | more →</a></p>
				</div>
				<div class="yit-widget widget col1_4 one-fourth col widget-last-post group">
					<img class="icon-img" src="{{config('app.theme')}}/images/icons/blog1.png" alt="" />        
					<div>
	...
	<div class="mobile-slider">
		<div class="slider fixed-image inner"><img src="{{ asset(config('app.theme')) }}/images/slider-cycle/cycle-fixed.jpg" alt="" /></div>
	</div>
	@endif