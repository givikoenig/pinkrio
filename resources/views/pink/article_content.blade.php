<div id="content-single" class="content group">
	<div class="hentry hentry-post blog-big group ">
		...
		<div class="thumbnail">
			...
			<div class="image-wrap">
				<img src="{{ asset(config('app.theme')) }}/images/articles/{{ $article->img->max }}" alt="{{ $article->alias }}_img" title="{{ $article->title }}" />
		...
		<div class="meta group">
			...
			<p class="comments"><span><a href="#comments" title="Comment on This is the title of the first article. Enjoy it.">{{ count($article->comments) ? count($article->comments) : 'No' }} {{-- Lang::choice('ru.comments',count($article->comments)) --}} comments</a></span></p>
		</div>
		<!-- post content -->
	...
	<div id="comments">
		<h3 id="comments-title">
			<span>{{ count($article->comments) ? count($article->comments) : 'No' }}</span> comments
		...
		<ol class="commentlist group">
			...
			@include(config('app.theme').'.comment',['items' => $comments])
	...
	<h3 style="color: #939191;">No articles here</h3>
